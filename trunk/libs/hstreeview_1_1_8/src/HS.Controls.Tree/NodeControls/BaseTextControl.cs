...
namespace HS.Controls.Tree.NodeControls
{
	public abstract class BaseTextControl : EditableControl
	{
        ...
        private Color _text_color = SystemColors.ControlText;
		...
		public override void Draw(TreeNodeAdv node, DrawContext context)
		{
            ...
            else if (context.DrawSelection == DrawSelectionMode.None)
            {
                if (_text_color == SystemColors.ControlText)
                    text = SystemBrushes.ControlText;
                else
                    text = new SolidBrush(_text_color);
            }
        ...
        public event EventHandler<TreeViewAdvEventArgs> DrawText;
        protected void OnDrawText(TreeNodeAdv node)
        {
            if (DrawText != null)
                DrawText(this, new TreeViewAdvEventArgs(node));
        }
